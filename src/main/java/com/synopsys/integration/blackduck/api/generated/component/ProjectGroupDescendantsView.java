...
import com.synopsys.integration.blackduck.api.generated.component.ProjectGroupDescendantsItemsPathView;

// this file should not be edited - if changes are necessary, the generator should be updated, then this file should be re-created
public class ProjectGroupDescendantsView extends BlackDuckComponent {
    ...
    private String name;
    private java.util.List<ProjectGroupDescendantsItemsPathView> path;
    ...
    public java.util.List<ProjectGroupDescendantsItemsPathView> getPath() {
        return path;
    }

    public void setPath(java.util.List<ProjectGroupDescendantsItemsPathView> path) {
        this.path = path;
    }
