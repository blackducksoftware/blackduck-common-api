...
import com.synopsys.integration.blackduck.api.generated.view.ComponentsView;
...
import com.synopsys.integration.blackduck.api.generated.view.TypesView;
...
public class MediaTypeDiscovery {
	...
	public MediaTypeDiscovery() {
    			...
    			mediaTypeMap.put(ComponentsView.class, "application/vnd.blackducksoftware.component-detail-4+json");
    			...
    			mediaTypeMap.put(TypesView.class, "application/vnd.blackducksoftware.admin-4+json");
