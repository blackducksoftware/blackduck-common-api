...
public class ApiDiscovery {
    ...
    public static final BlackDuckPath<DeveloperScansScanView> DEVELOPER_SCANS_PATH = new BlackDuckPath("/api/developer-scans", DeveloperScansScanView.class, false);
    ...
    public UrlSingleResponse<DeveloperScansScanView> metaDeveloperScansLink() {
