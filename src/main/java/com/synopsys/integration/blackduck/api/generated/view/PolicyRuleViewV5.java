...
import com.synopsys.integration.blackduck.api.generated.component.PolicyRuleViewExpressionV5;

//this file should not be edited - if changes are necessary, the generator should be updated, then this file should be re-created
public class PolicyRuleViewV5 extends BlackDuckView {
    private PolicyRuleSeverityType severity;
    private PolicyRuleViewExpressionV5 expression;
    private String name;
    ...
    public PolicyRuleViewExpressionV5 getExpression() {
    return expression;
    }

    public void setExpression(PolicyRuleViewExpressionV5 expression) {
