...
import com.synopsys.integration.blackduck.api.generated.enumeration.ProjectVersionPolicyStatusComponentVersionPolicyViolationDetailsNameType;
...
public class ProjectVersionPolicyStatusComponentVersionPolicyViolationDetailsView extends BlackDuckComponent {
    ...
    private ProjectVersionPolicyStatusComponentVersionPolicyViolationDetailsNameType name;
    ...
    public ProjectVersionPolicyStatusComponentVersionPolicyViolationDetailsNameType getName() {
	return name;
    }

    public void setName(ProjectVersionPolicyStatusComponentVersionPolicyViolationDetailsNameType name) {
	this.name = name;
    }
